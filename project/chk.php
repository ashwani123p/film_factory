            ...
            <div class="card-body">
              ...
              <p class="card-text text-muted">
                ...
                ?>
                  ...
                  <?php
                  if($count == 0){ ?>
                  <a href="rent.php?id=<?php echo $j ?>" class="btn btn-success btn-xs pull-right card-link">Rent!</a>
                  <?php }
                  ...
                  <br>
                    ...
                    You have Already Rented <?php echo $Name ?> for 3 days!
                  </div>
                  <?php } ?>
            </div>
          </div>
