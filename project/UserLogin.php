...
if (isset($_POST['submit'])) {
  ...
  if (count($errors) == 0) {
    ...
    $query = "INSERT INTO registration (FirstName, LastName, UserName, Email, PassWord)
...
<a href="#" onclick="ocultar_login_sign_up()" ><i class="material-icons">&#xE5C4;</i></a>
   <h2>LOGIN</h2>
   <form class="form-inline my-2 my-lg-0" method="post" action ="UserLoginCheck.php" >
...
<footer>
 ...
 <button class="btn_sign_up" onclick="window.location.href='admincheck.php'" >ADMIN LOGIN</button>
</html>
